...
*******************************************************/
//配网页面代码1
const String page_html1 = R"(<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><meta name="viewport"content="width=device-width,initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0,user-scalable=no"><title>ESP32-WIFI配网</title><style type="text/css">*{margin:0;padding:0;box-sizing:border-box}html,body{height:100%;background-color:lightseagreen;background-size:cover}h2{text-align:center;color:white;line-height:2.2}.dowebok{position:absolute;left:50%;top:30%;width:380px;height:500px;margin:-200px 0 0-200px;border:3px solid white;border-radius:10px;overflow:hidden}.form-item{position:relative;width:360px;margin:0 auto;padding-bottom:20px}.form-item input{width:288px;height:48px;padding-left:10px;border:1px solid white;border-radius:25px;font-size:18px;color:white;background-color:transparent;outline:none}.send_button{width:360px;height:50px;border:0;border-radius:25px;font-size:18px;color:green;outline:none;cursor:pointer;background-color:white}.dowebok::placeholder{font-size:18px;line-height:1.4;color:white}@media screen and(max-width:500px){.dowebok{position:static;width:auto;height:auto;margin:0 30px;border:0;border-radius:0}.form-item{width:auto}.form-item input,.form-item button{width:100%}}</style></head><body><div class="dowebok"><h2>WIFI配置</h2><form style='text-align: center;padding-top: 20px'name='input'action='/'method='POST'><div class="form-item"><input id="username"type="text"name='ssid'autocomplete="off"placeholder="WiFi名称"list="data-list"><datalist id="data-list">)";
//Web配网模式下用于储存扫描到的WiFi ID
String scanNetworksID = "";
//配网页面代码2
const String page_html2 = R"(</datalist></div><div class="form-item"><input id="password"type="password"name='password'autocomplete="off"placeholder="WiFi密码"></div><div class="form-item"><div><input id="send_button"type='submit'value='保存并连接'></div></div><div class="form-item"><div class="user_text"><p><h3>如何配置WIFI:</h3><h5>输入要连接的WIFI名字和密码,点击保存并连接</h5></p></div></div></form></div></body></html>)";
